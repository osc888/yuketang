...
headers = {
    ...
    'Cookie': 'csrftoken=' + csrftoken + '; sessionid=' + sessionid + '; university_id=3333; platform_id=3',
...
def one_video_watcher(video_id,video_name,cid,user_id,classroomid,skuid):
    ...
    url = "https://tfswufe.yuketang.cn/video-log/heartbeat/"
    get_url = "https://tfswufe.yuketang.cn/video-log/get_video_watch_progress/?cid="+str(cid)+"&user_id="+user_id+"&classroom_id="+classroomid+"&video_type=video&vtype=rate&video_id=" + str(video_id) + "&snapshot=1&term=latest&uv_id=3333"
...
def get_videos_ids(course_name,classroom_id,course_sign):
    get_homework_ids = "https://tfswufe.yuketang.cn/mooc-api/v1/lms/learn/course/chapter?cid="+str(classroom_id)+"&term=latest&uv_id=3333&sign="+course_sign
...
if __name__ == "__main__":
    ...
    user_id_url = "https://tfswufe.yuketang.cn/edu_admin/check_user_session/"
    ...
    # 然后要获取教室id
    get_classroom_id = "https://tfswufe.yuketang.cn/mooc-api/v1/lms/user/user-courses/?status=1&page=1&no_page=1&term=latest&uv_id=3333"
    submit_url = "https://tfswufe.yuketang.cn/mooc-api/v1/lms/exercise/problem_apply/?term=latest&uv_id=3333"
